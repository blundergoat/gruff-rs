...
shellcheck scripts/preflight-checks.sh scripts/start-dev.sh .claude/hooks/deny-dangerous.sh .claude/hooks/gruff-code-quality.sh
```
...
Rationalisations to reject: see `.goat-flow/skill-reference/skill-preamble.md`.
