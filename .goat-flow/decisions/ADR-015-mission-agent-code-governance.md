...
- Known divergences to reconcile against this mission (open as of 2026-05-30):
  - the complexity scanners count control-flow keywords inside comments (`src/built_in_rules/blocks.rs`), inflating `cyclomatic` / `cognitive` / `nesting-depth` — and they do so via the doc comments the mission mandates;
