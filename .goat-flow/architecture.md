...
- `src/report.rs` (`gruff.analysis.v1`), `src/summary.rs` (`gruff.summary.v2`), `src/render/hotspot.rs` (`gruff.hotspot.v1`), and `src/render/sarif.rs` (SARIF 2.1.0) contain the public schema strings; changing them is a compatibility decision.
